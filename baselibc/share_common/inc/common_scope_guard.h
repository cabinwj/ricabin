...
#define loki_ON_BLOCK_EXIT(...)      ::loki::ScopeGuard loki_ANONYMOUS_VARIABLE(scopeGuard) = ::loki::MakeGuard(__VA_ARGS__); ((void)loki_ANONYMOUS_VARIABLE(scopeGuard))
#define loki_ON_BLOCK_EXIT_OBJ(...)  ::loki::ScopeGuard loki_ANONYMOUS_VARIABLE(scopeGuard) = ::loki::MakeObjGuard(__VA_ARGS__); ((void)loki_ANONYMOUS_VARIABLE(scopeGuard))
